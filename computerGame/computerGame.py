...
class GameComp:
    ...
    def win_screen(self):
        ...
        self.window.blit(win_img, (317, 375))
    ...
    def draw_text(self):
        ...
        y = 60
        if self.turn == "p1":
            pygame.draw.rect(self.window, self.bg, (x, y, 400, 60))
            text = "Turn : You"
            img = font.render(text, True, pygame.Color(colour))
            self.window.blit(img, (860, y))
        elif self.turn == "p2":
            pygame.draw.rect(self.window, self.bg, (x, y, 400, 60))
            text = "Turn : Computer"
            img = font.render(text, True, pygame.Color(colour))
            self.window.blit(img, (800, y))
    ...
    def score(self):
        ...
        if self.winner == "Win!":
            self.player_score += 1
        elif self.winner == "Lose!":
            self.computer_score += 1
        font = pygame.font.SysFont('Verdana', 40)
        
        text = f"Wins : {self.player_score}"
        img = font.render(text, True, pygame.Color(255, 255, 255))
        self.window.blit(img, (170, 30))
        
        text = f"Loses : {self.computer_score}"
        img = font.render(text, True, pygame.Color(255, 255, 255))
    ...
    def loading(self):
        for i in range(3):
            ...
            text = self.text[i]
            img = font.render(text, True, pygame.Color(255, 255, 255))
            self.window.blit(img, (920, 40))
            pygame.display.update()
            time.sleep(0.5)
        pygame.draw.rect(self.window, self.bg, (920, 100, 100, 50))
