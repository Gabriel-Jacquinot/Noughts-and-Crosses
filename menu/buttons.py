...
class Button: # Making a class for any button that gets made so that you can very easily make multiple by just inputing the properties you want it to have
    def __init__(self, font, size, boolean1, text, boolean2, bgColour, textColour, posx, posy, length, width, borderColour, hoverColour = None): # This is a placeholder which will be different for each button, enter a set of values for each variable to make a button
        ...
        self.defaultColour = pygame.Color(bgColour)
        self.borderColour = borderColour
        self.hoverColour = pygame.Color(hoverColour) if hoverColour else self.colour
